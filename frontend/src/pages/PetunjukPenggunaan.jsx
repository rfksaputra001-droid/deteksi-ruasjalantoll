...
const steps2 = [
  ...
  '3. Sistem akan secara otomatis menginput data dan menghitung rumus .',
      ...
      <Card className="border border-gray-300">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-700 text-sm" style={{fontFamily: 'Poppins, sans-serif', fontWeight: 400}}>A: Sistem mendukung format MP4, AVI, MOV dengan resolusi minimum 480.</p>
          </div>
          <div>
