  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <Card className="bg-green-50 border border-green-200">
        <h3 className="text-lg font-bold text-green-900 mb-4" style={{fontFamily: 'Poppins, sans-serif', fontWeight: 700}}>📞 Hubungi Administrator</h3>
      ...
      <Card className="bg-blue-50 border border-blue-200">
        ...
        <ul className="space-y-3 text-blue-900 text-sm">
          ...
          <li style={{fontFamily: 'Poppins, sans-serif', fontWeight: 500}}>• <span className="font-semibold">Database:</span> PostgreSQL</li>
