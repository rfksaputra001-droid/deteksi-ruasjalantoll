...
// Menu items dengan level akses
// roles: 'all' = semua role, 'surveyor' = surveyor & admin, 'admin' = admin only
const menuItems = [
  { name: 'Dashboard', path: '/dashboard', icon: imgDashboard, roles: ['admin', 'surveyor', 'user'] },
  { name: 'Deteksi', path: '/deteksi', icon: imgDeteksi, roles: ['admin', 'surveyor'] },
  { name: 'Perhitungan', path: '/perhitungan', icon: imgPerhitungan, roles: ['admin', 'surveyor'] },
  { name: 'Histori', path: '/histori', icon: imgHistori, roles: ['admin', 'surveyor'] },
  { name: 'Informasi Website', path: '/informasi', icon: imgInformasi, roles: ['admin', 'surveyor', 'user'] },
  { name: 'Petunjuk', path: '/petunjuk', icon: imgPetunjuk, roles: ['admin', 'surveyor', 'user'] },
]
